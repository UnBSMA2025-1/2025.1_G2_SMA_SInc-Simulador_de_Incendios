...
public class FirefighterAgent extends Agent {
    ...
    private void perceive() {
        ...
        System.out.println("BELIEEEFSSS" + beliefs.size());

        if (!beliefs.isEmpty()) {
            System.out.println("FirefighterAgent " + getLocalName() + " perceives " + beliefs.size() + " fires");
        }
        else{
            System.out.println("AGEEENTSSS" + getLocalName());
            this.takeDown();
        }
    }
    ...
    protected void takeDown() {
        map.removeFirefighterAgent(getLocalName()); // Remove agente da lista
        super.takeDown();
    }
    ...
    private boolean isValidMove(int newX, int newY) {
        ...
        return tile != null && tile.getType() != 7; // Can't move through water
    }
